...
-- telescope-fzf-native needs `make` to build its C library, see the
-- `PackChanged` hooks in config/pack.lua. Skip it entirely without `make`.
if vim.fn.executable("make") == 1 then
	table.insert(specs, "nvim-telescope/telescope-fzf-native.nvim")
end
